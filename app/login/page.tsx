      ...
      <div className="animate-slide-up w-full max-w-md">
        <div className="premium-card p-8 sm:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-[rgba(0,0,0,0.5)] mt-2 text-[15px]">Sign in to your dashboard</p>
          </div>
          ...
          <p className="text-center text-sm text-[rgba(0,0,0,0.5)] mt-6">
            ...
            <Link href="/signup" className="text-[#1B1C15] font-semibold hover:opacity-60 transition-opacity">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
